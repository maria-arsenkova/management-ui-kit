...
import website from '../SidebarMenu/img/website.png';
import communication from '../SidebarMenu/img/communication.png';
...
function Sidebar() {
  return (
    <div className='sidebar'>
      ...
      <UserInfo user={user} />
      <Stats tasks={tasks} />
      <SidebarMenu content={menu} />
      <SidebarMenu content={projects} />
      <SidebarMenu content={teams} />
      <SidebarFooter />
    </div>
  );
}
